 ...
 * in {@link com.kenyarealestate.user.config.CorrelationIdFilterConfig} so the
 * MDC value is set before Spring Security's filter chain runs, covering log
 * lines emitted by auth failures too.
 */
