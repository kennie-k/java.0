...
export const SUB_COUNTIES_BY_COUNTY: Record<string, string[]> = {
...
export function subCountyOptions(county: string | undefined) {
  return (county ? SUB_COUNTIES_BY_COUNTY[county] ?? [] : []).map(s => ({ value: s, label: s }))
}
